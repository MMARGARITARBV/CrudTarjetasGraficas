...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-06-2017 a las 23:28:18
...
('tgraficas', 'ESTADO\"', 'int', '11', '', 0, ',', ''),
('tgraficas', 'ID', 'int', '11', '', 0, ',', ''),
('tgraficas', 'MARCA', 'int', '11', '', 0, ',', ''),
('tgraficas', 'NOMBRE', 'int', '11', '', 0, ',', ''),
('tgraficas', 'TAMANO_MEMORIA', 'int', '11', '', 0, ',', ''),
('tgraficas', 'TIPO_GRAFICA', 'int', '11', '', 0, ',', ''),
('tgraficas', 'TIPO_MEMORIA', 'int', '11', '', 0, ',', '');
...
('root', '[{\"db\":\"tgraficas\",\"table\":\"graficas\"}]');
...
('root', '2017-05-28 22:03:50', '{\"lang\":\"es\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
--
CREATE DATABASE IF NOT EXISTS `tgraficas` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `tgraficas`;
...
(7, 'EVGA GeForce GTX 1050 SC Gaming', 'EVGA', 'Nvidia', 'GDDR5', 2, 'Nuevo', 150),
(8, 'Gigabyte Geforce GTX 1060 Windforce OC', 'Gigabyte', 'Nvidia', 'GDDR5', 6, 'Nuevo', 251),
(9, 'MSI GeForce GTX 1050Ti 4G OC', 'MSI', 'Nvidia', 'GDDR5', 5, 'Nuevo', 115);
